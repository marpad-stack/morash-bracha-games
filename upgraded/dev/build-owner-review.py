...
'<section class="intro"><p><b>הערות הכותבות נשמרו במלואן.</b> המצב המופיע כאן הוא מצב הביצוע בפרויקט, ולא סימון של הכותבות שהן אישרו את הגרסה הסופית. כל 86 ההערות עדיין מסומנות כפתוחות במערכת המשותפת; לא שיניתי אותן.</p><p>במתחמים א׳ וב׳ בוצעו שינויים ונשמרו בדיקות. המשחקים ג׳–י׳ עדיין מחכים למעבר משותף: בחלקם קיימים תיקונים טכניים קודמים, אך אין להסיק מכך שכל בקשות הכותבות הושלמו.</p><p><a href="הסיפור-נוסח-מוצע.html">הנוסח החדש שאישרת</a> שולב בספר עם מקום לרגשות ולתמיכה של ההורים. נוספה גרסה מקבילה עם חני, בלשון נקבה ובאיורים מותאמים. מוזיקת רקע ומחולל צביעה מתמונה אישית לא נוספו.</p></section>',
...
'<section class="intro"><h2>הבקשות האחרונות שלך</h2><p>הספר נבנה מחדש: 28 עמודים בכל גרסה, מענדי או חני. הסבתא לצד האמא, ספר הסיפורים המצויר פונה לקוראים, והלוגו השחור מוטמע על האיור ללא מסגרת. נוספו כפולות במחשב, 11 רגעי שיחה ומשחק קצר, והדפסה ב־A4 מלא או מקופל. התיקונים האלה הם תוספות שלך לסבב הכותבות.</p><p>איורים חסרים: בבדיקה לפני העדכון ארבע תמונות (14, 22, 24, 25) הוחלפו ברשת בתמונות זעירות וריקות. במהדורה החדשה 17 איורים ייחודיים נטענו בבדיקות המקומיות ובחבילת ההורדה ללא אינטרנט. לאחר הפרסום נבדקו 17 האיורים החדשים: 13 נטענו; איורי השבת והלילה של מענדי וחני מוחלפים בתמונות 1×1 ברשת הנוכחית. החשד הוא לסינון הרשת, והנושא נשאר פתוח לבירור מול הספק.</p></section>']
