(() => {
 ...
 if(part==='a'){
  help(find('#games')||find('[data-game="memory"]')?.parentElement,'בוחרים רמה בראש העמוד ואז משחק.\nבזיכרון הופכים שני קלפים ומחפשים זוג.\nבפאזל בוחרים שני חלקים כדי להחליף ביניהם.\nבבלשי החפצים מחפשים את החפץ בין שלושה ציורים.\nכפתור ״סגירה״ מחזיר לבחירת המשחקים.');
 }
 if(part==='b'){
