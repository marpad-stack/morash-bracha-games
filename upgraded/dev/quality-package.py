...
s=s.replace('הנוסח הקיים נשמר עד לקבלת העריכה החדשה. שבעה איורים תוקנו לפי ההערות, והנוסח שבתוכם נשמר.','שבעה איורים תוקנו; נוסח הסיפור הנוכחי נשמר. בהמשך מצורפת תצוגת קריאה מתומללת, עם ניקוד ובלעדיו.')
s=s.replace('</main>','<h2>תוספת לסבב השדרוג — קריאה נגישה</h2><p>בספר נשמרו 40 העמודים, שבעה איורים תוקנו ונוסח הסיפור הקיים נשמר. קיימת תצוגת קריאה למלל של 36 העמודים שבהם יש טקסט. ארבעה עמודים הם איורים ללא מלל. הטקסט תומלל מול התמונות, כולל בועות בחירה וכיתובים קטנים; כדאי לעבור עליו בהגהה לפני הפרסום.</p>'+''.join(reading_html)+'</main>')
p.write_text(s,encoding='utf-8')
